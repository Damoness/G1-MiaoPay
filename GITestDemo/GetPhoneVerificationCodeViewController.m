...
- (IBAction)getPhoneVerificationCode:(id)sender {
    ...
    NSString *url = [NSString stringWithFormat:@"http://%@:%@/MposApp/queryAuthCode.action?phone=%@&flag=mdzf",kServerIP,kServerPort,phoneNo];
    ...
    [manager GET:url parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (code == 0) {
            ...
            [KUserDefault setObject:phoneNo forKey:qiyeShoujihao];
            [KUserDefault setObject:phoneNo forKey:gerenShoujihao];
