...
@property (weak, nonatomic) IBOutlet UITextField *yingyedizhi;
 ...
 *  开户许可证
 */
@property (weak, nonatomic) IBOutlet UIButton *kaihuxukezheng;
/**
 *  现场照片
 */
@property (weak, nonatomic) IBOutlet UIButton *xianchangzhaopian;
