...
- (void)viewDidLoad {
    ...
    selectedIndex = -1;
    isOpen = false;
    _array = [[NSMutableArray alloc]initWithArray:@[@"设备信息",@"交易规则",@"使用帮助",@"关于我们",@"客服电话",@"服务账号"]];
...
//    }
    ...
    if (indexPath.row == 0) {
        ...
        SheBeiXinXiViewController *shebeixinxiVc = [[SheBeiXinXiViewController alloc] init];
        [self.navigationController pushViewController:shebeixinxiVc animated:YES];
        
    }else if (indexPath.row == 1){
       
        JiaoYiGuiZeViewController *jiayiGuiZeVc = [[JiaoYiGuiZeViewController alloc] init];
        [self.navigationController pushViewController:jiayiGuiZeVc animated:YES];
    
    }else if (indexPath.row == 2){
        
        ShiYongBangZhuViewController *bangzhuVc = [[ShiYongBangZhuViewController alloc] init];
    ...
    }else if (indexPath.row == 4){//客服电话
        
        
        UIViewController *kfdhVC = [[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"KFDH"];
        
        [self.navigationController pushViewController:kfdhVC animated:YES];
    }else if (indexPath.row == 5){//服务账号
        
        UIViewController *kfdhVC = [[UIStoryboard storyboardWithName:@"Main" bundle:nil]instantiateViewControllerWithIdentifier:@"FWZH"];
